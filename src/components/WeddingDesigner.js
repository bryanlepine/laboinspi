        ...
        <div className='designer-wrapper'>
            ...
            <div className='designer-container'>
                <div className='designer-text'>
                    ...
                    <p>En collaboration avec des partenaires soigneusement sélectionnés tels que fleuristes, infographistes et prestataires de décoration et de mobilier, nous concevons un projet complet pour célébrer votre union.</p>
